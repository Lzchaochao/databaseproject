$(document).ready(function () {
    ...
    layui.use(['table', 'form'], function () {
        ...
        tableIns = table.render({
            ...
            cols: [
                [
                    ...
                    {
                        field: 'deadLine', title: '截止时间', width: 180, sort: true, align: "center",
                        templet: function (d) {
        ...
        table.on('tool(option)', function (obj) {
            ...
            if (obj.event === 'view') {
                ...
                layer.open({
                    ...
                    //maxmin: true,
                    title: '修改  ' + data.title,
                    content: '/html/main/person/update-iframe.html'
                });
                        ...
                        success: function (reply) {
                            if (reply.code == 1) {
                                ...
                                for (k = 0; k < tableData.length; k++) {
                                    if (tableData[k].litterId == data.litterId) {
        ...
        $("#addBtn").click(function () {
            layer.open({
                ...
                //maxmin: true,
                title: '添加新任务',
                content: '/html/main/person/add-iframe.html'
            });
            return false;
        });
    });
    ...
    window.setUpdateDataFromIFrame = function setUpdateDataFromIFrame(reData) {
        ...
        for (k = 0; k < tableData.length; k++) {
            if (tableData[k].litterId == reData.litterId) {
                tableData[k] = reData;
                break;
            }
        }
